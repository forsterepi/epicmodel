...
split_prc <- function(prc) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Output validation error: {.var out$causes}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Output validation error: {.var out$non_start_steps}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Output validation error: {.var out$interventions}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Output validation error: {.var out$ifnot_steps}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Output validation error: {.var out$end_steps}", .internal = TRUE,
...
transform_if_list <- function(if_list) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var if_list}", .internal = TRUE,
...
is_fulfilled <- function(if_list, current_list_then) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var current_list_then}", .internal = TRUE,
...
is_fulfilled_outc <- function(outc_list, final_list_then) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var final_list_then}", .internal = TRUE,
...
next_round_of_steps <- function(steps_left, current_list_then) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var steps_left}", .internal = TRUE,
...
is_sufficient <- function(cc, row, non_start_steps, outc_list) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var cc}", .internal = TRUE,
                                             parent = cnd, class = "input_cc")
  })

  rlang::try_fetch({
      checkmate::assert_integerish(row, lower = 1, any.missing = F, null.ok = F)
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var row}", .internal = TRUE,
  ...
  rlang::try_fetch({
      ...
      checkmate::assert_subset(colnames(outc_list), c("sce","id"), empty.ok = F)
      checkmate::assert_integerish(outc_list$sce %>% as.numeric(), lower = 1, any.missing = F, null.ok = F)
    }, error = function(cnd) {cli::cli_abort("Input validation error {.var outc_list}", .internal = TRUE,
                                             parent = cnd, class = "input_outc_list")
  })
  #=============================================================================
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Output validation error: {.var out$is_suff}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Output validation error: {.var out$final_list}", .internal = TRUE,
...
minimize_sc <- function(sc) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var sc}", .internal = TRUE,
  ...
  rlang::try_fetch({
    checkmate::assert_data_frame(sc, types = "logical", any.missing = F, null.ok = F, min.cols = 1, min.rows = 1,
                                 col.names = "unique", row.names = "unique")
    checkmate::assert_character(rownames(sc), pattern = "^cc[[:digit:]]+$")
  }, error = function(cnd) {cli::cli_abort("Output validation error: {.var sc}", .internal = TRUE,
...
get_sc_to_check_for_ifnot <- function(sc, sc_final_steps, ifnot_steps){
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var sc_final_steps}", .internal = TRUE,
                                             parent = cnd, class = "input_sc_final_steps")
  })

  if (rownames(sc) %>% magrittr::equals(names(sc_final_steps)) %>% all() %>% magrittr::not()) {
    cli::cli_abort("Input validation error: {.var sc_final_steps}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var ifnot_steps}", .internal = TRUE,
...
check_ifnot <- function(re_sc, row, sc_final_steps, prc, prc_split, outc_list) {
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var re_sc}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var prc_split}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var prc_split$non_start_steps}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var prc_split$ifnot_steps}", .internal = TRUE,
  ...
  rlang::try_fetch({
    ...
    }, error = function(cnd) {cli::cli_abort("Input validation error: {.var prc_split$end_steps}", .internal = TRUE,
  ...
  if (to_remove$suff %>% any() & to_remove$suff %>% all() %>% magrittr::not()) {
    ...
    rlang::try_fetch({
      ...
      }, error = function(cnd) {cli::cli_abort("Output validation error: {.var sc_status_temp}", .internal = TRUE,
    ...
    rlang::try_fetch({
      ...
      }, error = function(cnd) {cli::cli_abort("Output validation error: {.var order}", .internal = TRUE,
                                               parent = cnd, class = "output_order")
    })

    rlang::try_fetch({
        checkmate::assert_logical(potential_implausible_ordering, any.missing = F, null.ok = F, len = 1)
      }, error = function(cnd) {cli::cli_abort("Output validation error: {.var potential_implausible_ordering}", .internal = TRUE,
    ...
    if (potential_implausible_ordering) {
      rlang::try_fetch({
        ...
        }, error = function(cnd) {cli::cli_abort("Output validation error: {.var potential_implausible_ordering_then}", .internal = TRUE,
