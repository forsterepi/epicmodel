...
First, launch the app with `launch_steplist_creator()`. Unfortunately, in `epicmodel` version 0.1.1, the app is still optimized for a big screen and using it on a laptop might be difficult.
